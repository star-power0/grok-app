...
export const zhAccount = {
  ...
  "account.heatmapHint": "本机 Grok Build 会话活动（约一年）。颜色按 Token 用量；悬停看用量；点击某天按会话数筛选下方日志。",
  ...
  "account.loginHelpBody": "若浏览器出现 Access denied / 无法生成授权码：请换网络或 VPN，改用「设备码登录」，或在设置中配置自定义中转。",
